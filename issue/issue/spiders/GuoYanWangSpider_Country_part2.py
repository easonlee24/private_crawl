...
class GuoYanWangSpider_Country_part2(scrapy.Spider):
    name = "GuoYanWangSpider_Country2"
    ...
    subjects = {'项目': '8008', "法规": '8007', '咨迅': '8009'}
    ...
    def parse_issue(self, response):
        ...
        keywords = "".join(response.xpath(".//div[@id='docKeywords']//text()").extract())
